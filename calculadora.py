...
class Calculadora(tk.Tk):
    def __init__(self):
        ...
        # Caja de texto (input)
        self.entrada = None
        # Utilizamos StringVar para obtener el valor del input
    ...
    def _creacion_componentes(self):
        entrada_frame = tk.Frame(self, width=200, height=50, bg='grey')
        ...
        boton_dividir = tk.Button(
            botones_frame, text='/', width=10, height=3,
            bd=0, bg='#eee', cursor='hand2',
